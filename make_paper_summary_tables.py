...
if __name__ == "__main__":
    ...
    print("*")
    print("*=================================*")
    print("* MoEDAL: Make the Summary Tables *")
    print("*=================================*")
    print("*")
    ...
    lg.info(" *")
    lg.info(" *=======================================*")
    lg.info(" * MoEDAL: Make the Paper Summary Tables *")
    lg.info(" *=======================================*")
    lg.info(" *")
...
\\begin{table}[ht]
\\small
\\caption{\label{tab:papersTABLE_NUM}MoEDAL-related publications (TABLE_NUM/NUM_TABLES).}
\\lineup
\\begin{indented}
